...
procedure imprimirLista(L:Lista);
	begin
		while(L<>nil) do begin
			...
			writeln('Fecha: ',L^.dato.fecha.dia,'/',L^.dato.fecha.mes);
            writeln('Cantidad de días prestados:  ',L^.dato.cantdiasprest);
			L:=L^.sig;
		end;
	end;
...
procedure ImprimirArbol2(a2:arbol2);
	begin
		if (a2<>nil) then begin
			writeln(a2^.dato.codISBN);
			imprimirLista(a2^.dato.listaPres);
