...
procedure insertarEnArbolLista(var a2:arbol; p:prestamo);
	begin
		if (a2=nil) then begin
			...
			if (p.ISBN < a2^.dato.ISBN)  then insertarEnArbolLista(a2^.HI,p)
				else if (p.ISBN > a2^.dato.ISBN) then insertarEnArbolLista(a2^.HD,p)
				  else 
